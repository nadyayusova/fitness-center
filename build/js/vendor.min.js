...
/*!**********************!*\
  !*** ./js/vendor.js ***!
  \**********************/
/*! exports provided: trainersSwiper, reviewsSwiper */
...
var trainersSwiper = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.trainers__swiper', {
  navigation: {
...
var reviewsSwiper = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__swiper', {
  navigation: {
    ...
    if (params.loadPrevNext) {
      if (slidesPerView > 1 || params.loadPrevNextAmount && params.loadPrevNextAmount > 1) {
        ...
        for (var _i8 = activeIndex + slidesPerView; _i8 < maxIndex; _i8 += 1) {
          if (slideExist(_i8)) loadInSlide(_i8);
        }
...
function HashNavigation(_ref16) {
...
function freeMode(_ref18) {
  ...
  function onTouchEnd(_ref19) {
    var currentPos = _ref19.currentPos;
    var params = swiper.params,
        $wrapperEl = swiper.$wrapperEl,
        rtl = swiper.rtlTranslate,
        snapGrid = swiper.snapGrid,
...
function EffectCoverflow(_ref22) {
...
var modules = [Virtual, Keyboard, Mousewheel, Navigation, Zoom, Lazy, Controller, A11y, History, HashNavigation, Thumb, freeMode, Grid, Manipulation, EffectCoverflow];
Swiper.use(modules);
